...
* ** Verification & Hallucination Detector Agent**: Acts as an independent auditor. It cross-references every extracted claim against the raw source text to detect AI hallucinations or contradictions. It categorizes claims into `SUPPORTED`, `CONTRADICTED`, or `UNVERIFIED_HALLUCINATED`.
